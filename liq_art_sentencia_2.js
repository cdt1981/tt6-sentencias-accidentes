...
<br/>
	...
	<span class="negrita">Así lo voto.</span><br/>
    <br/>
	A la misma cuestión, el Dr. Dos Santos dijo:<br/>
	...
	2.- Que el actor presenta, como daño actual, una ..., todo lo cual le ocasionó una incapacidad física del ${incFisica} de la t.o.
		Asimismo el actor padece una R.V.A.N. de grado II, la cual le generó una incapacidad psicológica del ${incPsicologica} %.
		En consecuencia, por aplicación del principio de la capacidad restante y en virtud de los factores de ponderación indicados por la experta médica (dificultad intermedia para la realización de tareas habituales – 15 % - y edad – 3 % -), tengo por probado que el Sr. ${nombreActor} resulta portador de una incapacidad psicofísica del ${incapacidad * 100} % de la T.O., todo ello de conformidad con lo informado por el perito médico. 
		Sobre el particular cabe destacar que, luego de haber leído y analizado las impugnaciones efectuadas al informe pericial médico, considero que el informe presentado adquiere verdadera fuerza probatoria por resultar el mismo científicamente fundado por un galeno competente para ello (cf. art. 474 del CPCC).
	3.- Que el evento dañoso acreditado en el punto I de la presente cuestión ha resultado idóneo para la producción del daño referido en el párrafo que antecede, conclusión a la cual corresponde arribar de conformidad con lo informado por el perito médico.
	4.- Que el promedio de las doce últimas remuneraciones percibidas por el accionante con anterioridad a la fecha del accidente – VIBM – alcanzó la suma de $ ${ingBase}, ello de conformidad con lo informado por la AFIP.<br/>
	5.- Que, al momento de la primera manifestación invalidante, al trabajadora tenía ${edad} años de edad, de conformidad con la documentación acompañada junto con el escrito de inicio de demanda.<br/>
	6.- La existencia de una relación laboral habida entre la parte actora y ${empleador}, ello en virtud del implícito reconocimiento efectuado por la propia demandada al contestar demanda, donde reconoce haber celebrado un contrato de afiliación con la empleadora, a lo que se aduna la documentación emitida por AFIP y acompañada en autos con fecha.<br/>
...
<br/>
	...
	Negó los hechos introducidos por el accionante. <br/>
	Impugnó liquidación. <br/>
	Contestó los planteos de inconstitucionalidad formulados por la parte actora. <br/>
	Ofreció pruebas. <br/>
	Peticionó se rechace la demanda instaurada en su contra con expresa imposición de costas a la contraria.<br/>
    ...
    <br/>
	Asimismo, desde la fecha de la primera manifestación invalidante (${fechaAccidente(document.getElementById("fechaAccidente").valueAsNumber)}) y hasta el momento de la liquidación que se practique por Secretaría, el ingreso base (${formula_objetc.vibm}) devengará un interés equivalente al promedio de la tasa activa cartera general nominal anual vencida a treinta (30) días del Banco de la Nación Argentina (art. 12, inc. 2° de la ley 24.557, mod. por el art. 11 de la ley 27.348). <br/>
	A su vez, y en virtud de lo dispuesto por el Art. 770, inc. "b", C.C y C.N., deberá hacerse efectiva la acumulación de los intereses generados desde la fecha en que cada suma es debida y hasta la fecha en que se notificó el traslado de la demanda incoada (17/5/19). <br/>
    ...
    <br/>
	<span class="negrita"> A la misma cuestión, el Dr. Dos Santos dijo: </span><br/>
	...
	Representación letrada parte actora: <br/>
    	A favor de la Dra.  ${abogadoActor} en la cantidad de JUS equivalentes al 18 % por su actuación en la presentación de la demanda, en la etapa probatoria y en la audiencia de Vista de Causa. <br/>
	A favor de la representación letrada de ${demandada}: <br/>
	A favor de la  Dra. ${abogadoDemandada} en la cantidad de jus equivalentes al 12 % por su actuación en la contestación de la demanda, en la etapa probatoria y en la audiencia de Vista de Causa.<br/>
	Peritos: <br/>
    	Y los de la perito médico ... en un 4,5 %.
	En todos los casos con más el aporte de ley correspondiente sobre el resultante del capital más los intereses, el que surgirá de la liquidación a practicarse por Secretaría (arts. 16, 21 y concs. de la ley 14.697; ley 12.207 - texto conf. leyes 12.696 y 13.314 -).<br/>
	Por los fundamentos expuestos,<br/>
    <span class="negrita">Así lo voto.</span><br/>
    <br/>
